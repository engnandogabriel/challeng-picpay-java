...
public class Payee extends User {
    private Payee(String id, String name, String document, String email, String password, String typeUser, Number amount) throws Exception{
        this.user_id = id;
    ...
    public static Payee restore(String id, String name, String document, String email, String password, String typeUser, Number amount) throws Exception {
